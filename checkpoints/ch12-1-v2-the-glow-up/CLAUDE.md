...
- Art style bible: every sprite prompt includes "chunky cute cartoon
  style, thick dark outlines, soft cel shading, subtle gloss,
  saturated colors". Sprites via tools/generate_sprite.py (python,
  --out for path), scaled in-engine, hitboxes never change with art.
